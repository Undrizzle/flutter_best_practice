            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Text(
                    DateUtil.getFormatTime(DateTime.fromMicrosecondsSinceEpoch(widget.mVideo.createtime)).toString() + 
                        '  ' + widget.mVideo.playnum.toString() + '次观看',
                    style: TextStyle(
                      fontSize: 13,
                      color: Colors.grey
                    )    
                      ...
                      Expanded(
                        child: InkWell(
                          child: Column(
                            children: <Widget>[
                              Image.asset(
                                Constant.ASSETS_IMG + 'video_detail_download.png',
                                width: 27.0,
                                height: 27.0,
                              ),
                              Container(
